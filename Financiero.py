...
def obtenerPortada():
    ...
    info = get_simple("https://www.elfinancierocr.com")
...
def crearCarpeta (nom) :
    if not os.path.exists(nom):
        os.makedirs(nom)
        os.makedirs(nom+"/ELFINANCIEROCR.COM")
    elif not os.path.exists(nom+"/ELFINANCIEROCR.COM"):
        os.makedirs(nom + "/ELFINANCIEROCR.COM")
    os.chdir(nom + "/ELFINANCIEROCR.COM")
